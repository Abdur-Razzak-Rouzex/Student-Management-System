<h1 class="text-primary"><i class="fa fa-user-plus"></i> Add New Student</small></h1>
<ol class="breadcrumb">
...
<?php
    if(isset($_POST['add-student'])){
        ...
        if($result){
            ...
            move_uploaded_file($_FILES['picture']['tmp_name'], 'std_img/'.$picture_name);
        }else{
...
<div class="row">
    <div class="col-sm-6">
        ...
        <div class="form-group">
            ...
            <input type="text" name="roll" id="roll" class="form-control" placeholder="6 digit roll" pattern="[0-9]{6}" required>
        </div>
        <div class="form-group">
            <label for="pcontact">Parents Contact Numer</label>
            <input type="text" name="pcontact" id="pcontact" class="form-control" placeholder="01*********" pattern="01[1|3|5|6|7|8|9][0-9]{8}" required>
        </div>
        <div class="form-group">
